...
;;; Each rule asserts a (rejected) fact with a plain-English reason.
;;;
;;; Rule Groups:
;;;   F1-F9  : Original constraint filters
;;;   F10    : Reject discrete GPU when use case does not need it
;;;   F11    : Reject gaming-category laptops for non-gaming users
;;;                                              Total: 11 rules
;;; ============================================================


;;; ============================================================
;;; GROUP 4 — Filtering and Elimination Rules (original: F1-F9)
;;; ============================================================
...
;;; ============================================================
;;; GROUP 4 EXTENDED — Tighter Filtering Rules (F10-F11)
;;; These rules reduce over-recommendation when the knowledge base
;;; contains many high-spec models and the use case is lightweight.
;;; ============================================================

;;; Rule F10: Reject discrete GPU laptops for use cases that do not need one.
;;; Discrete GPU laptops are heavier, more expensive, and noisier than
;;; their integrated equivalents. For browsing and business users,
;;; recommending a gaming-class GPU is misleading and wasteful.
...
;;; Gaming laptops are optimised for sustained GPU throughput, not
;;; productivity. They trade battery life, fan noise, and portability
;;; for raw graphics performance that browsing and business users
;;; will never utilise. This rule applies only when the user has NOT
;;; specified gaming as their primary use.
